            ...
            <div>
                ...
                <form class="login-form" id="login-form" method="post" action="index.php?page=login">
                    <div>
                        ...
                        <input type="password" name="login-password" <?php if(isset($_POST['login-password'])) { echo 'value=' . Utilities::escape($_POST['login-password']); } ?>><br>
                    </div>
                    <div>
            ...
            <div>
                ...
                <form class="login-form" id="signup-form" method="post" action="index.php?page=login&create=true<?php echo Utilities::escape($_GET['id'] ? '&id=' . $_GET['id'] : ''); ?>">
                    <div>
                        ...
                        <label for="password">Password: </label>
                        <input type="password" name="create-password" <?php if(isset($_POST['create-password'])) { echo 'value=' . Utilities::escape($_POST['create-password']); } ?>><br>

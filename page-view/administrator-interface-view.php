<?php if ($_SESSION['username'] === 'administrator') : ?>
    ...
    <div>
        ...
        <?php foreach ($movies as $movie) : ?>
            <ul>
                ...
                <li>Showings: <?php echo $movie->getShowings(); ?></li>
    ...
    <div>
        ...
        <?php foreach ($users as $user) : ?>
            ...
            <?php endif; ?>
            <form method="post" action="index.php?page=administrator-interface&delete-user=<?php echo $user['userId']; ?>">
                <button type="submit" name="delete-user" value="<?php echo $user['id']; ?>">Delete Booking</button>
            </form>
        <?php endforeach ?>
    </div>
